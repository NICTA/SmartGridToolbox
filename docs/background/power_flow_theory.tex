...
Each bus has an associated load. 
\begin{align*}
...
\begin{align}
\frac{\partial \re{I}_i}{\partial \re{V}_{k}} &= \frac{P'_{ci}}{M_i^2} - \frac{2\re{V}_i(P'_{ci}\re{V}_i + Q'_{ci}\im{V}_i)}{M_i^4} - G'_{ik} \\
\frac{\partial \re{I}_i}{\partial \im{V}_{k}} &= \frac{Q'_{ci}}{M_i^2} - \frac{2\im{V}_i(P'_{ci}\re{V}_i + Q'_{ci}\im{V}_i)}{M_i^4} + B'_{ik} \\
\frac{\partial \im{I}_i}{\partial \re{V}_{k}} &= -\frac{Q'_{ci}}{M_i^2} - \frac{2\re{V}_i(P'_{ci}\im{V}_i - Q'_{ci}\re{V}_i)}{M_i^4} - B'_{ik} \\
\frac{\partial \im{I}_i}{\partial \im{V}_{k}} &= \frac{P'_{ci}}{M_i^2} - \frac{2\im{V}_i(P'_{ci}\im{V}_i - Q'_{ci}\re{V}_i)}{M_i^4} - G'_{ik} \\
\end{align}

For PV busses, the power flow equations also hold, but with an variable $Q_{\text{bus}}$ and an extra constraint:
\begin{align}
\re{V}_{i}^2 + \im{V}_i^2 = M^2_{\text{PV}}
\end{align}
The unknowns are $V_I$ and $Q$. $V_R$ is replaced by $Q$ in $x$.  
\end{document}