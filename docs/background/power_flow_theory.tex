...
We assume that all generators are phase-locked -- that is, there is a single value $\Delta \omega := \Delta \dot{\theta}$ that applies for all generators, although the individual generators will in general have a constant phase difference, as dictated by the static AC power flow equations. This may ignore certain types of very short timescale transients.
