...
\begin{align}
	I_A &= \maa(V_A - V_B) - \mab(V_a - V_b) \notag \\
	I_B &= -\maa(V_A - 2V_B + V_C) + \mab(V_a - 2V_b + V_c)\\
	I_C &= \maa(V_C - V_B) - \mab(V_c - V_b) \notag \\
	I_a &= -\mba(V_A - V_B) + \mbb(V_a - V_b) \notag \\
	I_b &= \mba(V_A - 2V_B + V_C) - \mbb(V_a - 2V_b + V_c) \\
	I_c &=  -\mba(V_C - V_B) + \mbb(V_c - V_b)
\end{align}
...
Y &= 
y_l\begin{bmatrix}
	\maa{1} & -\maa{1} & 0 & -\mab{1} & \mab{1} & 0 \\
	-\maa{1} & \maa{2} & -\maa{1} & \mab{1} & -\mab{2} & \mab{1} \\
	0 & -\maa{1} & \maa{1} & 0 & \mab{1} & -\mab{1} \\
	-\mba{1} & \mba{1} & 0 & \mbb{1} & -\mbb{1} & 0 \\
	\mba{1} & -\mba{2} & \mba{1} & -\mbb{1} & \mbb{2} & -\mbb{1} \\
