...
\begin{align}
	V &\leftarrow V_1 = \sqrt{3} V_A,\; \text{effectively the line to line voltage, or RMS,} \notag \\
	I &\leftarrow I_1 = \sqrt{3} I_A,\; \text{effectively the RMS,} \notag \\
	Z &\leftarrow Z_{11} = z - m,\; \text{line impedance, see Eq. \ref{EQ_Z012}.}
\end{align}
