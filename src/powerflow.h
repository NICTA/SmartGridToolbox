...
GLOBAL MATRIXSOLVERMETHOD matrix_solver_method INIT(MM_SUPERLU);
...
GLOBAL unsigned int NR_branch_count INIT(0);         
...
GLOBAL double primary_voltage_ratio INIT(60.0);      
   /**< primary voltage ratio (@todo explain primary_voltage_ratio in powerflow (ticket #131) */
