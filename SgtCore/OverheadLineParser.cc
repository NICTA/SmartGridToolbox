...
{
   void OverheadLineParser::parse(const YAML::Node& nd, Network& netw, const ParserState& state) const
   {
   ...
   std::unique_ptr<OverheadLine> OverheadLineParser::parseOverheadLine(const YAML::Node& nd,
