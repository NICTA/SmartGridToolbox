...
#ifndef POWER_FLOW_NR_POL_SOLVER_DOT_H
#define POWER_FLOW_NR_POL_SOLVER_DOT_H
...
namespace Sgt
{
    ...
    class PowerFlowNrPolSolver : public PowerFlowSolverInterface
    {
        public:
...
#endif // POWER_FLOW_NR_POL_SOLVER_DOT_H
