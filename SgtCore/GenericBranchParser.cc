...
namespace SmartGridToolbox
{
   ...
   void GenericBranchParser::parse(const YAML::Node& nd, Network& netw, const ParserState& state) const
   {
   ...
   std::unique_ptr<GenericBranch> GenericBranchParser::parseGenericBranch(const YAML::Node& nd,
